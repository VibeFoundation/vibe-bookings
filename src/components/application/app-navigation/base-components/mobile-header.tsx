				...
				{({ state }) => (
					<>
						<AriaButton
							...
							onPress={() => state.close()}
							className="fixed rtl:left-2 rtl:justify-end top-3 right-2 flex cursor-pointer items-center justify-center rounded-lg p-2 text-fg-white/70 outline-focus-ring hover:bg-white/10 hover:text-fg-white focus-visible:outline-2 focus-visible:outline-offset-2"
						>
							<CloseIcon className="size-6" />
						</AriaButton>

						<AriaModal className=" cursor-auto will-change-transform rtl:fixed rtl:right-0">
