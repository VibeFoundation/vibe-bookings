...
import { authPrivateMiddlewareRequest } from "@/server/auth-middleware";

export const ServerRoute = createServerFileRoute("/api/electric/$table")
	.middleware([authPrivateMiddlewareRequest])
	.methods({
